...
class ReleaseMetadataTests(unittest.TestCase):
    def test_version_metadata_has_one_consistent_release_identity(self):
        ...
        self.assertEqual(WINDOWS_FILE_VERSION_STRING, "3.1.0.0")
        self.assertEqual(EXE_FILENAME, "CRISPY BITS DESKTOP v3.1.0.exe")
        self.assertEqual(RELEASE_TAG, "crispy-bits-desktop-v3.1.0")
