...
class ReleaseMetadataTests(unittest.TestCase):
    def test_version_metadata_has_one_consistent_release_identity(self):
        ...
        self.assertEqual(APP_VERSION, "3.4.1")
        self.assertEqual(aggits_video_factory.__version__, APP_VERSION)
        self.assertEqual(WINDOWS_FILE_VERSION_STRING, "3.4.1.0")
        self.assertEqual(EXE_FILENAME, "CRISPY BITS DESKTOP v3.4.1.exe")
        self.assertEqual(RELEASE_TAG, "crispy-bits-desktop-v3.4.1")
